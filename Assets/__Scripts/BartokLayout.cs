...
// BSlotDef class is not based on MonoBehaviour, so it doesn't need its own file
[System.Serializable] // Make BSlotDef able to be seen in the Unity Inspector
public class BSlotDef
{
    public float x;
    public float y;
    ...
    public Vector3 pos;     // Pos derived from x, y, and multiplier
...
public class BartokLayout : MonoBehaviour
{
    ...
    // BSlotDef references
    public List<BSlotDef> bSlotDefs;  // The BSlotDefs hands
    public BSlotDef drawPile;
    public BSlotDef discardPile;
    public BSlotDef target;
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        {
            tSD = new BSlotDef();  // Create a new BSlotDef instance
